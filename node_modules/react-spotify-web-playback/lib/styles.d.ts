...
declare const keyframes: ((frames: object, block?: string | undefined) => string) | undefined, put: (selector: string, css: CssLikeObject, atrule?: string | undefined) => void, styled: (tag: string) => (styles: CssLikeObject, dynamicTemplate?: ((props: StyledProps) => CssLikeObject) | undefined, block?: string | undefined) => React.FunctionComponent<Partial<StyledProps>>;
